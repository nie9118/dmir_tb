...
D_MODEL=16              # 大幅减小d_model (16→8) 减少参数量
N_HEADS=8              # 减少注意力头 (8→4)
E_LAYERS=3             # 减少层数 (3→2) 加速训练
D_FF=64                # 减小FFN维度 (64→32)
PATCH_LEN=16
STRIDE=8
...
do
    ...
    python -u ../run_longExp.py \
      ...
      --use_gpu True \
      --gpu 2 \
      --itr 1 --batch_size ${BATCH_SIZE} --learning_rate ${learning_rate}  | tee logs/LongForecasting/etth2/${model_name}_${model_id_name}_${seq_len}_${pred_len}_${T_num_expert}_${T_top_k}_${F_num_expert}_${F_top_k}_${learning_rate}_0.1.log
