...
PATCH_LEN=16
STRIDE=8
T_NUM_EXPERT=4         # 减少专家数 (16→8) 关键优化!
T_TOP_K=1
F_NUM_EXPERT=4        # 减少专家数 (16→8) 关键优化!
F_TOP_K=1
...
do
    ...
    python -u ../run_longExp.py \
      ...
      --use_gpu True \
      --gpu 2 \
      --itr 1 --batch_size ${BATCH_SIZE} --learning_rate ${learning_rate}  | tee logs/LongForecasting/etth1/${model_name}_${model_id_name}_${seq_len}_${pred_len}_${T_num_expert}_${T_top_k}_${F_num_expert}_${F_top_k}_${learning_rate}_0.1.log
