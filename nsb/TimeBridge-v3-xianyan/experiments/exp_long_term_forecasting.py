        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.output_attention:
                    outputs,x,x_enc_init = self.model(batch_x, batch_x_mark, dec_inp, batch_y_mark)[0]
                else:
                    outputs,x,x_enc_init = self.model(batch_x, batch_x_mark, dec_inp, batch_y_mark)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                other_loss = self.time_freq_mae(batch_x, x)*0.000001
                loss+=other_loss
                train_loss.append(loss.item())
                #train_loss.append(other_loss.item())
