...
# Traffic dataset uses the generic custom CSV loader.
...
# The public Traffic dataset is commonly 862 variables.
...
do
    ...
    python -u ../run_longExp.py \
      ...
      --use_gpu True \
      --gpu 0 \
      --itr 1 --batch_size ${BATCH_SIZE} --learning_rate ${learning_rate}  | tee logs/LongForecasting/traffic/${model_name}_${model_id_name}_${seq_len}_${pred_len}_${T_num_expert}_${T_top_k}_${F_num_expert}_${F_top_k}_${learning_rate}_0.1.log
