...
class Dataset_CMU(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.flag == 'test':
            df_raw_path = f'./dataset/cmu_mocap/test/{self.args.data_path}/{self.args.data_path}_1.txt'
            df_raw = np.loadtxt(df_raw_path, delimiter=',')
        else:
            df_raw_list =  []
            for i in range(5):
                df_raw_path = f'./dataset/cmu_mocap/train/{self.args.data_path}/{self.args.data_path}_{i+1}.txt'
                df_raw_list.append(np.loadtxt(df_raw_path, delimiter=','))
            df_raw = np.concatenate(df_raw_list)
