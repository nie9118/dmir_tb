c = {
 ...
 "ETTm1": {
        "96": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTm1.csv   --data ETTm1   --features M     --enc_in 7   --dec_in 7   --c_out 7"
        ...
        "192": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTm1.csv   --data ETTm1   --features M     --enc_in 7   --dec_in 7   --c_out 7"
 ...
 "ETTm2": {
         "96": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTm2.csv   --data ETTm2   --features M     --enc_in 7   --dec_in 7   --c_out 7"
              "  --seq_len 96 --label_len 0  --pred_len  48  --model NSTS  --zd_dim 3  --hidden_dim 384  --hidden_layers 2   --dropout 0   --activation relu   --learning_rate 0.001  --is_bn --zd_kl_weight 0.0001 --zc_kl_weight 0.0001  --hmm_weight 0.0001 ",
        "192": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTm2.csv   --data ETTm2   --features M     --enc_in 7   --dec_in 7   --c_out 7"
              "  --seq_len 192 --label_len 0  --pred_len  96  --model NSTS  --zd_dim 3  --hidden_dim 512  --hidden_layers 2   --dropout 0.5   --activation relu  --learning_rate 0.001  ",
        "336": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTm2.csv   --data ETTm2   --features M     --enc_in 7   --dec_in 7   --c_out 7"
              "  --seq_len 288 --label_len 0  --pred_len  144  --model NSTS  --zd_dim 3  --hidden_dim 512  --hidden_layers 2   --dropout 0.5   --activation relu  --learning_rate 0.001  ",
        "720": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTm2.csv   --data ETTm2   --features M     --enc_in 7   --dec_in 7   --c_out 7"
              "  --seq_len 384 --label_len 0  --pred_len  192  --model NSTS  --zd_dim 3  --hidden_dim 128  --hidden_layers 1   --dropout 0   --activation relu  --learning_rate 0.001  ",

    },

    "ETTh2": {
        "96": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTh2.csv   --data ETTh2   --features M     --enc_in 7   --dec_in 7   --c_out 7 "
        ...
        "192": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTh2.csv   --data ETTh2   --features M     --enc_in 7   --dec_in 7   --c_out 7"
        ...
        "336": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTh2.csv   --data ETTh2   --features M     --enc_in 7   --dec_in 7   --c_out 7"
        ...
        "720": "python tune.py --root_path ./dataset/ETT-small/   --data_path ETTh2.csv   --data ETTh2   --features M     --enc_in 7   --dec_in 7   --c_out 7"
    ...
    "Exchange": {
        "96": "python tune.py --root_path ./dataset/exchange_rate/  --data_path exchange_rate.csv    --data custom    --features M     --enc_in 8  --dec_in 8   --c_out 8 "
        ...
        "192": "python tune.py --root_path ./dataset/exchange_rate/  --data_path exchange_rate.csv    --data custom    --features M     --enc_in 8  --dec_in 8   --c_out 8 "
        ...
        "336": "python tune.py --root_path ./dataset/exchange_rate/  --data_path exchange_rate.csv    --data custom    --features M     --enc_in 8  --dec_in 8   --c_out 8 "
        ...
        "720": "python tune.py --root_path ./dataset/exchange_rate/  --data_path exchange_rate.csv    --data custom    --features M     --enc_in 8  --dec_in 8   --c_out 8 "
    ...
    "ILI": {
        "24": "python tune.py --root_path ./dataset/illness/   --data_path national_illness.csv   --data custom    --features M     --enc_in 7   --dec_in 7   --c_out 7 "
        ...
        "36": "python tune.py --root_path ./dataset/illness/   --data_path national_illness.csv   --data custom    --features M     --enc_in 7   --dec_in 7   --c_out 7  "
        ...
        "48": "python tune.py --root_path ./dataset/illness/   --data_path national_illness.csv   --data custom    --features M     --enc_in 7   --dec_in 7   --c_out 7  "
        ...
        "60": "python tune.py --root_path ./dataset/illness/   --data_path national_illness.csv   --data custom    --features M     --enc_in 7   --dec_in 7   --c_out 7  "
    ...
    "Weather": {
        "96": "python tune.py --root_path ./dataset/weather/   --data_path weather.csv  --data custom    --features M     --enc_in 21   --dec_in 21   --c_out 21 "
        ...
        "192": "python tune.py --root_path ./dataset/weather/   --data_path weather.csv  --data custom    --features M     --enc_in 21   --dec_in 21   --c_out 21   "
        ...
        "336": "python tune.py --root_path ./dataset/weather/   --data_path weather.csv  --data custom    --features M     --enc_in 21   --dec_in 21   --c_out 21  "
        ...
        "720": "python tune.py --root_path ./dataset/weather/   --data_path weather.csv  --data custom    --features M     --enc_in 21   --dec_in 21   --c_out 21  "
    ...
    "ECL": {
        "96": "python tune.py    --root_path ./dataset/electricity/   --data_path electricity.csv   --data custom   --features M      --enc_in 321   --dec_in 321   --c_out 321 "
        ...
        "192": "python tune.py    --root_path ./dataset/electricity/   --data_path electricity.csv   --data custom   --features M      --enc_in 321   --dec_in 321   --c_out 321  "
        ...
        "336": "python tune.py    --root_path ./dataset/electricity/   --data_path electricity.csv   --data custom   --features M      --enc_in 321   --dec_in 321   --c_out 321  "
        ...
        "720": "python tune.py    --root_path ./dataset/electricity/   --data_path electricity.csv   --data custom   --features M      --enc_in 321   --dec_in 321   --c_out 321  "
    ...
    "Traffic": {
        "96": "python tune.py --root_path ./dataset/traffic/   --data_path traffic.csv --data custom    --features M     --enc_in 862  --dec_in 862  --c_out 862 "
        ...
        "192": "python tune.py --root_path ./dataset/traffic/   --data_path traffic.csv --data custom    --features M     --enc_in 862  --dec_in 862  --c_out 862  "
        ...
        "336": "python tune.py --root_path ./dataset/traffic/   --data_path traffic.csv --data custom    --features M     --enc_in 862  --dec_in 862  --c_out 862 "
        ...
        "720": "python tune.py --root_path ./dataset/traffic/   --data_path traffic.csv --data custom    --features M     --enc_in 862  --dec_in 862  --c_out 862"
