...
class CNNBackBone(nn.Module):
    ...
    def forward(self, x_enc, x_mark_dec):
        ...
        feature = self.conv_trans(dec_out)[:,-self.pred_len:] + trend
        return feature
...
class Encoder_ZC(nn.Module):
    def __init__(self, configs) -> None:
        ...
        self.net = Embedding_Net(configs.patch_size, configs.pred_len, configs.seq_len, configs.emb_dim)
    ...
    def forward(self, x_enc, x_mark_dec, is_train=True):
        x_enc = self.cnn(x_enc, x_mark_dec)
